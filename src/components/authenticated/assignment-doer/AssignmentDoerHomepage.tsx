...
function Homepage() {
  return (
    <div className='w-full h-full'>
      ...
      <div className='homepage-bg w-full h-screen p-2 flex flex-1 flex-col justify-center items-start'>
...
<button className='bg-white text-black rounded-md w-30 p-1'>Get Started</button>
      </div>  
