...
function ApplicationProcess() {
  return (
    <div className="bg-gray-100 p-10">
      <div className="flex primary-green items-center justify-center font-bold p-5">
      ...
      <div className="w-full  mx-auto">
        <div className="flex items-center justify-between">
          ...
          <div className="relative flex items-center">
            ...
            <div className="absolute top-0 left-1/2 transform -translate-x-1/2 translate-y-5 text-center text-xs py-5">
              Skills Survey
            </div>
          </div>
          {/* Line between steps */}
