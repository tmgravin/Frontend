    ...
    <div className="mt-10 mb-10 mx-auto p-8 bg-white border border-gray-300 shadow-lg max-w-5xl">
      ...
      <div className="space-y-6">
        <div>
          ...
          {openQuestion === 1 && (
            <p className="pl-4 text-gray-700">
              ...
              projects. The platform is overseen by an Admin who ensures smooth
              operations and compliance with our policies.
            </p>
          )}
        </div>
        ...
        <div>
          ...
          {openQuestion === 2 && (
            <ul className="pl-4 text-gray-700 list-disc">
              ...
              <li>
                <strong>Doer:</strong> A user who accepts and completes projects
                based on the instructions provided by the creator.
              </li>
            </ul>
          )}
        </div>
        ...
        <div>
          ...
          {openQuestion === 3 && (
            <p className="pl-4 text-gray-700">
              ...
              (Creator or Doer), and fill out the required information. Once
              your registration is complete, you’ll be able to start using the
              platform.
            </p>
          )}
        </div>
          ...
          {openQuestion === 4 && (
            <div className="pl-4 text-gray-700">
              ...
              <ul className="list-disc mb-4">
                ...
                <li>
                  Review completed projectss and request revisions if necessary.
                </li>
              ...
              <ul className="list-disc">
                ...
                <li>
                  Complete the projects according to the provided instructions.
                </li>
                <li>
        ...
        <div>
          ...
          {openQuestion === 5 && (
            <p className="pl-4 text-gray-700">
              Payments are processed through the platform. Creators deposit the
              agreed amount when submitting an project request. Once the Doer
              completes and the Creator approves the work, the payment is
