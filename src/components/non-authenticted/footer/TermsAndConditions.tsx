...
function TermsAndConditions() {
  ...
  return (
    <div className="m-4">
      ...
      <div className="max-w-3xl mx-auto py-8 border border-gray-300 bg-white shadow-lg">
        ...
        <p className="mb-4">
          ...
          Assignment Doer, and the overarching control by the Admin. By
        ...
        <ul className="list-disc pl-5 mb-4">
          ...
          <li>
            <strong>Assignment Doer:</strong> A user who receives, completes,
            and submits assignments based on requests from Assignment Creators.
          </li>
          <li>
        ...
        <ul className="list-disc pl-5 mb-4">
          ...
          <li>
            Is accountable for reviewing and accepting the completed
            assignments.
          </li>
        </ul>
        ...
        <ul className="list-disc pl-5 mb-4">
          ...
          <li>
            Has the authority to review, approve, or reject assignments and
            handle disputes between Assignment Creators and Assignment Doers.
          </li>
          <li>
        ...
        <p className="mb-4">
          Assignment Doers are expected to complete assignments in accordance
          with the provided instructions and within the specified deadlines.
          Failure to do so may result in penalties or account suspension.
        </p>
        ...
        <p className="mb-4">
          ...
          provide feedback or approval. If revisions are required, the
          Assignment Doer must address them in a timely manner.
        </p>
        ...
        <p className="mb-4">
          Any disputes between Assignment Creators and Assignment Doers should
          be resolved through the platform’s dispute resolution process. The
